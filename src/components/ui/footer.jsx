...
const navigation = [
  {
    name: 'Twitter',
    href: '#',  //TODO: Update with Twitter link
    icon: (props) => (
  ...
  {
    name: 'Discord',
    href: '#',  //TODO: Update with Discord link
    icon: (props) => (
      <svg
  ...
  {
    name: 'Instagram',
    href: '#',  //TODO: Update with Instagram link
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
    ...
    <footer className="mx-auto max-w-full px-8 sm:px-16 lg:px-32 mb-2 border-t border-gray-200">
      <div className="flex flex-col items-start justify-between pt-8 pb-6 gap-y-4 lg:flex-row lg:items-center lg:py-8">
        ...
        <div className="flex items-center text-gray-900">
          ...
          <div className="ml-4">
            <p className="text-base font-semibold">LivingIP</p>
