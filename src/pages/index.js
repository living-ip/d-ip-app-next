...
export default function Home() {
  ...
  return (
    <div className="bg-gradient-to-b from-[#002500] to-[#245D00]">
      <div
        className="flex overflow-hidden relative flex-col items-center px-5 w-full text-base font-medium leading-6 text-white max-md:max-w-full"
        style={{
          backgroundImage: `url('/landingpage/background2.png')`,
